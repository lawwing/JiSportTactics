...
public class MainRecordTacticFragment extends BaseFragment {
    ...
    private String[] names = {"录制战术", "回看战术"};

    private int[] bgcolors = {Color.GREEN, Color.BLACK};

    private int[] textcolors = {Color.WHITE, Color.WHITE};
